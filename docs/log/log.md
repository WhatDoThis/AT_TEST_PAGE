...
1. 2026-04-27 README Windows venv pip 명령 정리
2. 2026-04-27 Python venv·requirements.txt·gitignore 문서화
3. 2026-04-27 환경별 config __DEV__ 분기·deploy.sh·README·REQUIREMENTS
4. 2026-04-27 GitHub main 초기 푸시 및 loadConfig dev/prd 분기
5. 2026-04-27 프로젝트 폴더 git init 및 GitHub origin 연결
6. 2026-04-27 갤러리 한 줄·번호 선택·기본 숨김 UI 수정
7. 2026-04-27 frontend 폴더로 Expo 앱 이전 (모노레포)
8. 2026-04-27 AT_TEST_PAGE Expo 풀 코드 구현 (PRD 정합)
9. 2026-04-27 docs/main AT_TEST_PAGE PRD v1.0 작성
